...
- **予想カード**：6 枚
  <img src="{{site.baseurl}}/assets/img/brown.png" alt="予想カード（ちゃいろ）">
  </div>
  <img src="{{site.baseurl}}/assets/img/orange.png" alt="予想カード（オレンジ）">
  </div>
  <img src="{{site.baseurl}}/assets/img/pink.png" alt="予想カード（ピンク）">
  </div>
  <img src="{{site.baseurl}}/assets/img/purple.png" alt="予想カード（むらさき）">
  </div>
  <img src="{{site.baseurl}}/assets/img/skyblue.png" alt="予想カード（みずいろ）">
  </div>
  <img src="{{site.baseurl}}/assets/img/green.png" alt="予想カード（みどり）">
  </div>
...
### **出品・鑑定フェーズ**
1. 価格決定カードの値が小さい人から順に出品者となり、回答カードを公開します。
